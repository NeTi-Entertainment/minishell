...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/11/17 01:16:07 by caubert           #+#    #+#             */
/*   Updated: 2024/11/17 01:16:07 by caubert          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	check_pipe_sequence(char *input, int *i)
{
	int	count;
	int	j;
...
static int	check_pipe_start(char *input)
{
	int	i;
